                    ...
                    if (red == 255 && green == 201 && blue == 14) {
                        ...
                        for (int i = 0; i < rgbArray.length; i++) {
                            ...
                            if (red == 255 && green == 127 && blue == 39) {
                                ...
                                gameBoard.placePiece(new Squirrel(Colour.RED, Direction.getDirection(rgbArray[i][1]), row/4, col/4, 2), row/4, col/4, Direction.getDirection(rgbArray[i][1]), 2);
                            } else if (red == 195 && green == 195 && blue == 195) {
                                System.out.println("Grey Squirrel Head Space Detected with rotation " + rgbArray[i][1]);
                                gameBoard.placePiece(new Squirrel(Colour.GREY, Direction.getDirection(rgbArray[i][1]), row/4, col/4, 2), row/4, col/4, Direction.getDirection(rgbArray[i][1]), 2);
                            } else if (red == 239 && green == 228 && blue == 176) {
                               System.out.println("Brown Squirrel Head Space Detected with rotation " + rgbArray[i][1]);
                               gameBoard.placePiece(new Squirrel(Colour.BROWN, Direction.getDirection(rgbArray[i][1]), row/4, col/4, 3), row/4, col/4, Direction.getDirection(rgbArray[i][1]), 3);
                            } else if (red == 0 && green == 0 && blue == 0) {
                                System.out.println("Black Squirrel Head Detected with rotation " + rgbArray[i][1]);
                                gameBoard.placePiece(new Squirrel(Colour.BLACK, Direction.getDirection(rgbArray[i][1]), row/4, col/4, 3), row/4, col/4, Direction.getDirection(rgbArray[i][1]), 3);
                            }
                        }
                    } else if (red == 237 && green == 28 && blue == 36) {
                        System.out.println("Flower Space Detected");
                        gameBoard.placePiece(new Flower(), row/4, col/4, Direction.NORTH, 1);
                    }
                }
            }
        } catch (Exception e) {
